...
function generatenum() {
    ...
    if (window.location.href == 'https://1rjb.github.io/MyGame/LEVELS/level1.html') {
        ...
        num = Math.floor(Math.random() * 101) - 100;
    }
        ...
        num = Math.floor(Math.random() * 801) - 800;
    }
